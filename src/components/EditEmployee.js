        ...
        <Modal.Body>
                <form 
                    onSubmit={(e) => {
                      handleClose();
                        e.preventDefault();
                        console.log('hello from edit emmployee');
...
{/* input for form */}
        ...
        <button onClick={handleClose} className='shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded'>Close</button>
         ...
         <button form='editmodal' className='shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded'>Update</button>
